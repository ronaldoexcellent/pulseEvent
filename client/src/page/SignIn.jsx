      ...
      <div className="min-h-[calc(100vh-73px)] w-full bg-pulse-bg-light flex items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden">
        ...
        >
          <div className="text-center mb-8">
            ...
            <h2 className="text-xl font-black text-pulse-text-dark tracking-tight mt-3">Welcome Back</h2>
            <p className="text-xs font-medium text-pulse-text-dark/50 mt-1">Access your secure settlement ledger.</p>
          </div>
          ...
          <form onSubmit={handleCredentialsSubmit} className="space-y-4">
            ...
            >
              {isLoading ? 'Verifying...' : 'Authenticate Platform Entry ⚡'}
            </motion.button>
          </form>

          <div className="text-center mt-6 pt-5 border-t border-gray-100 text-xs font-semibold text-pulse-text-dark/60">
            <span>New to the grid? </span>
            <a href="/signup" className="text-pulse-purple-primary font-black hover:underline">Create Access Key</a>
          </div>
        </motion.div>
      </div>
    </GoogleOAuthProvider>
