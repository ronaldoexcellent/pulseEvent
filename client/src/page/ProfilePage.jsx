      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-10">
          <h1 className="text-4xl font-black text-gray-950 uppercase tracking-tighter">
            User <span className="text-[#f2378f]">Profile</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 flex flex-col gap-8">
            ...
            >
              ...
              <div className="absolute top-0 right-0 -mr-8 -mt-8 w-32 h-32 rounded-full bg-[#f2378f]/20 blur-2xl group-hover:bg-[#f2378f]/30 transition-all duration-700" />
              <div className="absolute bottom-0 left-0 -ml-8 -mb-8 w-32 h-32 rounded-full bg-[#5a1fb5]/20 blur-2xl group-hover:bg-[#5a1fb5]/30 transition-all duration-700" />
          ...
          <div className="lg:col-span-2 flex flex-col gap-8">
            ...
            >
              {/* Support Button Card */}
              <button className="flex items-center gap-5 p-6 bg-white rounded-[32px] border border-gray-100 shadow-sm hover:shadow-md hover:border-[#5a1fb5]/30 transition-all group text-left">
              ...
              <button className="flex items-center gap-5 p-6 bg-white rounded-[32px] border border-gray-100 shadow-sm hover:shadow-md hover:border-[#f2378f]/30 transition-all group text-left">
