    ...
    <>
      ...
      {hasShownLoader && (
        <div className="min-h-screen bg-pulse-bg-light text-gray-800 font-sans selection:bg-pulse-purple-primary/30 flex flex-col md:flex-row">
          {/* --- Mobile Top Navbar --- */}
          <header className="md:hidden fixed top-0 left-0 right-0 h-18 bg-white/80 backdrop-blur-xl border-b border-gray-200/60 z-50 flex items-center justify-between px-6">
          ...
          <nav className="
            ...
            bottom-5 left-4 right-4 h-18 bg-white/90 backdrop-blur-xl border border-gray-200/50 shadow-[0_8px_30px_rgb(0,0,0,0.08)] rounded-3xl flex flex-row items-center justify-between px-1 sm:px-2
                  ...
                  return (
                    <Link
                      ...
                      className={`
                        ...
                        ${isActive ? 'text-pulse-purple-primary' : 'text-gray-500 hover:text-gray-800 hover:bg-gray-50/50'}
                      `}
                    >
                      {isActive && (
                        <motion.div
              ...
              <div className="flex flex-col gap-3 w-full pt-6 border-t border-gray-200/60 mt-auto shrink-0">
                ...
                <div className="px-1 mb-2">
                  ...
                  >
                    ...
                    <div className="text-gray-300 group-hover:text-pulse-purple-primary transition-colors p-2 bg-gray-50 group-hover:bg-pulse-purple-primary/10 rounded-xl">
                      {showBalance ? (
              ...
              <AnimatePresence>
                {showFabMenu && (
                  ...
                  >
                    ...
                    >
                      <span className="text-pulse-purple-primary shrink-0">
                    ...
                    <Link
                      ...
                      className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-gray-50 text-gray-700 active:bg-gray-100 transition-colors"
                    >
                      <span className="text-pulse-pink-primary shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-5 h-5">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
                        </svg>
                      </span>
                  ...
                  <React.Fragment key={link.path}>
                    ...
                    {index === 2 && (
                      <button
                        ...
                        className="relative flex items-center justify-center w-14 h-14 bg-linear-to-tr from-pulse-purple-primary to-pulse-pink-primary text-white rounded-full shadow-lg shadow-pulse-purple-primary/30 -translate-y-5 border-4 border-pulse-bg-light focus:outline-none transition-transform active:scale-95 shrink-0 z-50"
                        title="Actions"
                      >
                        <motion.svg
                          xmlns="http://www.w3.org/2000/svg"
          ...
          {/* --- Main Content Shell --- */}
          <main className="flex-1 w-full pt-18 pb-28 md:pt-0 md:pb-0 md:ml-72 min-h-screen relative z-0">
