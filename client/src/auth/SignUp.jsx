            ...
            {step === 1 ? (
                  ...
                  <div>
                    <div className="relative">
                      <input 
                        ...
                        /* Appended pr-12 to your dynamic classes to prevent text overlap with the icon */
              ...
              <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }}>
                <form onSubmit={handleVerifySubmit} className="space-y-6">
                  ...
                  <button type="submit" disabled={isLoading} className="w-full py-3.5 bg-pulse-gradient hover:bg-pulse-gradient-hover text-white font-black text-sm rounded-xl shadow-lg shadow-pulse-purple-primary/20 cursor-pointer">
