    ...
    <section className="relative w-full min-h-[90vh] bg-pulse-bg-light flex items-center justify-center overflow-hidden pt-10 lg:pt-0">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
        ...
        >
          ...
          <div className="inline-block mb-4 px-4 py-1.5 rounded-full bg-pulse-purple-primary/10 border border-pulse-purple-primary/20">
            <span className="text-sm font-bold text-pulse-purple-primary tracking-wide">
          ...
          <p className="text-lg sm:text-xl text-pulse-text-dark/70 mb-8 max-w-2xl mx-auto lg:mx-0 font-medium">
